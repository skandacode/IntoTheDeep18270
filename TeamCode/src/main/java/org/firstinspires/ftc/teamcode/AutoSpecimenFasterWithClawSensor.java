...
@Config
@Autonomous
public class AutoSpecimenFasterWithClawSensor extends LinearOpMode {
    MecanumDrivetrain drive;
    Intake intake;
    Outtake outtake;
    public static boolean closedPressed=false;
    public static boolean scoredPressed=false;
    public static double correctDist=2.2;
    enum autoStates {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        WayPoint depositPosPreload2=new WayPoint(new Pose2D(DistanceUnit.INCH, -3, -26, AngleUnit.DEGREES, 90),
        ...
        WayPoint depositPos2=new WayPoint(new Pose2D(DistanceUnit.INCH, -6, -24, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  1, 1, AngleUnit.DEGREES, 2));
        WayPoint depositPos12=new WayPoint(new Pose2D(DistanceUnit.INCH, -10, -50, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  4, 4, AngleUnit.DEGREES, 3));
        WayPoint depositPos22=new WayPoint(new Pose2D(DistanceUnit.INCH, -10, -24, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  1, 1, AngleUnit.DEGREES, 2));
        WayPoint depositPos22Strafe=new WayPoint(new Pose2D(DistanceUnit.INCH, -5, -24, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  1, 1, AngleUnit.DEGREES, 2));
        WayPoint depositPos13=new WayPoint(new Pose2D(DistanceUnit.INCH, -8, -50, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  4, 4, AngleUnit.DEGREES, 3));
        WayPoint depositPos23=new WayPoint(new Pose2D(DistanceUnit.INCH, -8, -23, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  1, 1, AngleUnit.DEGREES, 2));
        WayPoint depositPos14=new WayPoint(new Pose2D(DistanceUnit.INCH, -11, -50, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  4, 4, AngleUnit.DEGREES, 3));
        WayPoint depositPos24=new WayPoint(new Pose2D(DistanceUnit.INCH, -11, -23, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  1, 1, AngleUnit.DEGREES, 2));
        ...
        WayPoint intakeExtend2Pos=new WayPoint(new Pose2D(DistanceUnit.INCH, 34, -37, AngleUnit.DEGREES, 34),
                new Pose2D(DistanceUnit.INCH, 1, 1, AngleUnit.DEGREES, 2));
        WayPoint intakeExtend3Pos=new WayPoint(new Pose2D(DistanceUnit.INCH, 42.5, -36, AngleUnit.DEGREES, 30),
                new Pose2D(DistanceUnit.INCH, 1, 1, AngleUnit.DEGREES, 2));
        ...
        WayPoint intakePreExtend2=new WayPoint(new Pose2D(DistanceUnit.INCH, 22, -42, AngleUnit.DEGREES, 30),
                new Pose2D(DistanceUnit.INCH, 1, 1, AngleUnit.DEGREES, 2));
        WayPoint specimenGrab=new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -47, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH, 1, 1, AngleUnit.DEGREES, 2));
        WayPoint specimenGrabForward=new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -53, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH, 0.5, 0.5, AngleUnit.DEGREES, 1));
        WayPoint specimenGrab2=new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -48, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH, 1, 1, AngleUnit.DEGREES, 2));
        WayPoint specimenGrabForward2=new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -53, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH, 0.5, 0.5, AngleUnit.DEGREES, 1));
        WayPoint specimenGrab3=new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -48.5, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH, 0.25, 0.25, AngleUnit.DEGREES, 2));
        WayPoint specimenGrabForward3=new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -51.5, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH, 0.25, 0.25, AngleUnit.DEGREES, 1));

        WayPoint park=new WayPoint(new Pose2D(DistanceUnit.INCH, 45, -54, AngleUnit.DEGREES, 180),
                new Pose2D(DistanceUnit.INCH, 1, 1, AngleUnit.DEGREES, 2));
        ...
        StateMachine autoMachine = new StateMachineBuilder()
                ...
                .onEnter(()-> {
                    closedPressed=true;
                    outtake.closeClaw();
                    drive.setTarget(new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -53-sensor.getDistance(DistanceUnit.INCH)+correctDist, AngleUnit.DEGREES, 90),
                            new Pose2D(DistanceUnit.INCH, 0.25, 0.25, AngleUnit.DEGREES, 0.5)));
                })
                .transitionTimed(0.3)
                ...
                .onEnter(()-> {
                    closedPressed=true;
                    outtake.closeClaw();
                    drive.setTarget(new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -52-sensor.getDistance(DistanceUnit.INCH)+correctDist, AngleUnit.DEGREES, 90),
                            new Pose2D(DistanceUnit.INCH, 0.25, 0.25, AngleUnit.DEGREES, 0.5)));
                })
                .transitionTimed(0.3)
                ...
                .onEnter(()-> {
                    closedPressed=true;
                    outtake.closeClaw();
                    drive.setTarget(new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -51-sensor.getDistance(DistanceUnit.INCH)+correctDist, AngleUnit.DEGREES, 90),
                            new Pose2D(DistanceUnit.INCH, 0.25, 0.25, AngleUnit.DEGREES, 0.5)));
                })
                .transitionTimed(0.5)
